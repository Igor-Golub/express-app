...
authRouter
  ...
  .post(AuthRouts.Recovery, ...authValidators.recovery, AuthController.recoveryPassword)
  .post(AuthRouts.NewPassword, ...authValidators.newPassword, AuthController.createNewPassword)
