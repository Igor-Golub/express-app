...
class BlogController implements Base.Controller {
  ...
  public create = async (req: Request<Record<string, unknown>, Models.BlogModelCreateAndUpdateDTO>, res: Response) => {
  ...
  public update = async (req: Request<{ id: string }, Models.BlogModelCreateAndUpdateDTO>, res: Response) => {
    const id = req.params.id;
